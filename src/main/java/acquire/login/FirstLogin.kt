...
import acquire.exception.EmptyFieldException
import acquire.exception.PinFieldsNotMatchingException
...
class FirstLogin internal constructor() : GridPane() {
    ...
    private fun checkFields() {
       //when (username) { "" -> throw acquire.kotlin.exception.EmptyFieldException("Enter Username") }
    ...
    init {
        val fxmlLoader = FXMLLoader(javaClass.getResource("/first_login.fxml"))
