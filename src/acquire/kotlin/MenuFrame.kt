 ...
 */
class MenuFrame : GridPane(), Initializable {
    
    private val actionTypes = ReadOnlyObjectWrapper<RecoupActionTypes>(this, "actionTypes")

    @FXML private lateinit var localRequest: RadioButton
    @FXML private lateinit var outsideRequest: RadioButton
    @FXML private lateinit var createWaybill: RadioButton
    @FXML private lateinit var confirmation: RadioButton
    @FXML private lateinit var menuSelection: ToggleGroup
    ...
    init {
        val fxmlLoader = FXMLLoader(javaClass.getResource("/acquire/fxml/menu_frame.fxml"))
